...
/**
 * Implements a SET_CONFIGURATION Request
 * @author E. Michael Maximilien
 * @version 1.0.0
 */
public class SetConfigurationRequest extends StandardRequest
{
	//-------------------------------------------------------------------------
	// Ctor(s)
	//
	 ...
	 */
	public SetConfigurationRequest( RequestFactory factory ) 
	{
		super( factory );
		init( SET_CONFIGURATION_BM_REQUEST_TYPE, (short)0, (short)0, new byte[ 0 ] );
	}
	...
	public byte getRequest() { return RequestConst.REQUEST_SET_CONFIGURATION; }

	/**
	 * Accepts a RequestVisitor object
	 * @param visitor the RequestVisitor object
	 */
	public void accept( RequestVisitor visitor ) { visitor.visitSetConfigurationRequest( this ); }

	/**
	 * @return the unique String name of this request.  This name should be the same
	 * for all instances of this Request
	 */
	public String getName() { return SET_CONFIGURATION_REQUEST_NAME; }
	...
	{ 
		if( b != SET_CONFIGURATION_BM_REQUEST_TYPE )
			throw new UsbRuntimeException( "Cannot set bmRequestType to anything other than " + SET_CONFIGURATION_BM_REQUEST_TYPE + " for a SetConfiguration request" );	

		bmRequestType = SET_CONFIGURATION_BM_REQUEST_TYPE;
	}
	...
	{ throw new UsbRuntimeException( "Data field not used in a SetConfiguration request" ); }

	//-------------------------------------------------------------------------
	// Class constants
	//

	public static final byte SET_CONFIGURATION_BM_REQUEST_TYPE = (byte)0x00;

	public static final String SET_CONFIGURATION_REQUEST_NAME = "SetConfigurationRequest";
}
