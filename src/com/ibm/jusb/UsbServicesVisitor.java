 ...
 * Each OS needs to provide a class implementing this interface
 * and provide necessary visitXyz methods
 * @author E. Michael Maximilien
 * @version 0.0.1 (JDK 1.1.x)
 */
public interface UsbServicesVisitor
{
    //-------------------------------------------------------------------------
    // Public methods
    //
     ...
     * @param nativeUsbServices the NativeUsbServices instance
     */
