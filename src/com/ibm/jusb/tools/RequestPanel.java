...
public class RequestPanel extends JPanel implements Cloneable
{
	...
	protected JTextField bmRequestTypeField = new JTextField("00", 2);
	...
	protected JTextField bRequestField = new JTextField("00", 2);
	...
	protected JTextField wValueField = new JTextField("0000", 4);
	...
	protected JTextField wIndexField = new JTextField("0000", 4);
